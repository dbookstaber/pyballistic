...
PROJECT_SRC = PROJECT_ROOT / 'pyballistic_exts'
...
def main():
    ...
    parser.add_argument(
        ...
        help="Directory containing Cython HTML annotation files. Defaults to 'pyballistic.exts/pyballistic_exts' relative to script parent."
    )
    parser.add_argument(
        "-o", "--output-dir",
        type=str,
