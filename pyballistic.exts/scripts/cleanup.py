...
cleanup_patterns = [
    ...
    "pyballistic_exts/*.c",    # Specific recursive file pattern for generated C files
    "pyballistic_exts/*.h",    # Specific recursive file pattern for generated header files
    "pyballistic_exts/*.html", # Specific recursive file pattern for HTML files
    "pyballistic_exts/*.pyd"   # Specific recursive file pattern for Pyd files
]
...
def cleanup():
    ...
    for pattern in cleanup_patterns:
        ...
        if is_non_recursive_file_pattern:
            ...
            # Handle recursive file patterns (e.g., "*.pyd", "pyballistic_exts/*.c")
