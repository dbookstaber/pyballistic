...
from pyballistic.conditions import Atmo, Coriolis, Wind
from pyballistic.drag_model import DragDataPoint
from pyballistic.interpolation import PchipPrepared, pchip_prepare, pchip_eval
...
class Shot:
    ...
    def __init__(self, *,
        ...
        Example:
            ```python
            from pyballistic import Weapon, Ammo, Atmo, Wind, Unit, Shot
            shot = Shot(
                ammo=Ammo(...),
                atmo=Atmo(...),
                weapon=Weapon(...),
