...
### Tests
* `pytest ./pyballistic.exts/tests` for cython-specific tests.
* We use `@pytest.mark.stress` to keep stress tests separate.  To run those: `pytest ./pyballistic.exts/tests -m stress`
